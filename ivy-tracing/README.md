...
You need first to build the demo tracing project, by running the following command in the root directory of this repository:
...
To aggregate the different traces from the different systems a unique trace id is generated at the Reverse Proxy.
...
After starting one of the examples with `docker compose up` you can go to http://localhost to start some processes.
